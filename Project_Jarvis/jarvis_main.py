        ...
        if "wake up" in query:
            ...
            while True:
                ...
                # make an alarm
                    ...
                    while True:
                        ...
                        if time_now == time:
                            ...
                            playsound(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\Downloads\music.mp3")
                            playsound(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\Downloads\music.mp3")
                ...
                # schedule my day function
                    ...
                    query = takeCommand().lower()
                    if "yes" in query:
                        file = open(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\tasks.txt", 'w')
                        file.write(f"")
                        file.close()
                        ...
                        for i in range(no_tasks):
                            ...
                            file = open(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\tasks.txt", 'a')
                ...
                # show schedule
                    ...
                    file = open(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\tasks.txt", 'r')
                    content = file.read()
                    file.close()
                    mixer.init()
                    mixer.music.load(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\Downloads\notification.mp3")
                    mixer.music.play()
                ...
                # cricket score function
                    ...
                    im.save(r"C:\Users\Lenovo\PycharmProjects\Project_Jarvis\ss.jpg")
